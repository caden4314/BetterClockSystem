...
class BasicDebugUI:
    ...
    def render_snapshot(self, snap: TimeNetworkSnapshot) -> None:
        ...
        lines = [
            ...
            f"Drop Total: {snap.total_dropped_packets}",
            f"Drop Rate: {snap.session_dropped_packets_per_sec:06.2f}/s",
            "",
            f"Source: {snap.source_label}",
            f"Clients Seen: {snap.clients_seen}",
            f"Total Requests: {snap.total_requests}   Dropped: {snap.total_dropped_packets}",
            "",
